...
use App\Policies\AppropriationOrdinanceVersionPolicy;
use App\Policies\BoardMemberCommitteeReportPolicy;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::policy(OrdinanceVersion::class, OrdinanceVersionPolicy::class);
        Gate::policy(AppropriationOrdinance::class, AppropriationOrdinancePolicy::class);
        Gate::policy(AppropriationOrdinanceVersion::class, AppropriationOrdinanceVersionPolicy::class);
        Gate::policy(ObDocument::class, ObDocumentPolicy::class);
        Gate::policy(User::class, UserPolicy::class);
        Gate::policy(DirectoryEntry::class, DirectoryEntryPolicy::class);
        Gate::policy(BoardMemberCommitteeReport::class, BoardMemberCommitteeReportPolicy::class);
