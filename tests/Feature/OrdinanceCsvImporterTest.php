...
CSV;
        ...
        $this->assertSame('2026-04-01', $ordinance->date_published_newspaper?->toDateString());
        $this->assertSame('2026-04-07', $ordinance->date_published_newspaper_end?->toDateString());
        $this->assertSame('April 1–7, 2026', $ordinance->newspaperPublicationPeriodDisplay());
