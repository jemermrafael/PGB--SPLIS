...
<body class="min-h-screen">
    @php
        $navItems = [
            ...
            ['label' => 'Resolutions', 'url' => route('resolutions.index'), 'active' => request()->routeIs('resolutions.*')],
            ...
            <div class="splis-header-top">
                <div class="splis-header-inner">
                    ...
                    <div class="splis-header-actions">
                        ...
                        <div class="splis-a11y-wrap">
                            <button type="button" id="splis-a11y-trigger" class="splis-header-btn" aria-expanded="false" aria-controls="splis-a11y-panel">
                        ...
                        <details class="splis-user-menu">
                            <summary class="splis-header-btn splis-user-menu-trigger">
                            ...
                            <div class="splis-user-menu-panel">
