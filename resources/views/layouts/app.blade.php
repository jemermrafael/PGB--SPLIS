                            ...
                            <div class="splis-user-menu-panel" data-dropdown-panel>
                                ...
                                @if (auth()->user()->canManageUsers())
                                    ...
                                    <a href="{{ route('admin.trash.index') }}" class="splis-user-menu-link inline-flex items-center gap-2">
                                        <svg class="h-4 w-4 shrink-0 opacity-80" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" aria-hidden="true">
                                    ...
                                    <a href="{{ route('admin.role-permissions.index') }}" class="splis-user-menu-link">Role permissions</a>
                                @endif
