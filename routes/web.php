...
use App\Http\Controllers\AgendaRequestFileController;
use App\Http\Controllers\AgendaRequestFileDeleteController;
use App\Http\Controllers\AgendaRequestFileImportController;
use App\Http\Controllers\AgendaRequestFileUploadController;
...
use App\Http\Controllers\AppropriationOrdinanceSearchController;
...
use App\Http\Controllers\OrdinanceVersionPdfController;
...
use App\Http\Controllers\SessionCommitteeReportsMirrorController;
...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/my-committee-reports', [BoardMemberCommitteeReportController::class, 'store'])->name('board-member.committee-reports.store');
    Route::get('/my-committee-reports/{committeeReport}/edit', [BoardMemberCommitteeReportController::class, 'edit'])->name('board-member.committee-reports.edit');
    ...
    Route::get('/ordinances/{ordinance}/versions/{version}/file/{type}', OrdinanceVersionPdfController::class)->name('ordinances.versions.file')->withTrashed();
    Route::delete('/ordinances/{ordinance}/versions/{version}', [OrdinanceController::class, 'destroyVersion'])->name('ordinances.versions.destroy');
    ...
    Route::get('/appropriation-ordinances/search', AppropriationOrdinanceSearchController::class)->name('appropriation-ordinances.search');
    ...
    Route::get('/agenda/{agenda}/request-files/{file}', AgendaRequestFileController::class)->name('agenda.request-files.show')->withTrashed();
    Route::post('/agenda/{agenda}/request-files', AgendaRequestFileUploadController::class)->name('agenda.request-files.store');
    Route::post('/agenda/{agenda}/request-files/import-disk', AgendaRequestFileImportController::class)->name('agenda.request-files.import-disk');
    Route::delete('/agenda/{agenda}/request-files/{file}', AgendaRequestFileDeleteController::class)->name('agenda.request-files.destroy');
    ...
    Route::prefix('order-of-business')->name('ob.')->group(function () {
        ...
        Route::delete('/{legislativeSession}/pdf/{slot}', SessionPdfDeleteController::class)->name('sessions.pdf.destroy');
        Route::post('/{legislativeSession}/mirror-pdfs', SessionPdfMirrorController::class)->name('sessions.mirror-pdfs');
        Route::post('/{legislativeSession}/committee-reports/mirror', SessionCommitteeReportsMirrorController::class)->name('sessions.committee-reports.mirror');
        ...
        Route::get('/{legislativeSession}/committee-report-summary/maker', [CommitteeReportSummaryController::class, 'maker'])->name('sessions.committee-report-summary.maker');
        Route::put('/{legislativeSession}/committee-report-summary', [CommitteeReportSummaryController::class, 'update'])->name('sessions.committee-report-summary.update');
        Route::post('/{legislativeSession}/committee-report-summary/sync', [CommitteeReportSummaryController::class, 'sync'])->name('sessions.committee-report-summary.sync');
        Route::get('/{legislativeSession}/committee-report-summary/print', [CommitteeReportSummaryController::class, 'print'])->name('sessions.committee-report-summary.print');
        ...
        Route::get('/attendance/monthly/maker', [SessionAttendanceController::class, 'monthlyMaker'])->name('sessions.attendance.monthly.maker');
        Route::put('/attendance/monthly', [SessionAttendanceController::class, 'monthlyUpdate'])->name('sessions.attendance.monthly.update');
        Route::get('/attendance/monthly/print', [SessionAttendanceController::class, 'monthlyPrint'])->name('sessions.attendance.monthly.print');
