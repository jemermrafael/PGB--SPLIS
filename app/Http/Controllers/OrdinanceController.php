...
class OrdinanceController extends Controller
{
    ...
    protected function validatedOrdinance(Request $request, ?Ordinance $ordinance = null): array
    {
        ...
        $validated = $request->validate([
            ...
            'pdf' => ['nullable', 'file', 'mimes:pdf', 'max:307200'],
            ...
            'mov_bulletin_pdf' => ['nullable', 'file', 'mimes:pdf,jpg,jpeg,png,gif,webp', 'max:307200'],
            'mov_certification' => ['nullable', 'string', 'max:200'],
            'mov_certification_url' => ['nullable', 'string', 'max:500'],
            'mov_certification_pdf' => ['nullable', 'file', 'mimes:pdf,jpg,jpeg,png,gif,webp', 'max:307200'],
            'mov_newspaper' => ['nullable', 'string', 'max:200'],
            'mov_newspaper_url' => ['nullable', 'string', 'max:500'],
            'mov_newspaper_pdf' => ['nullable', 'file', 'mimes:pdf,jpg,jpeg,png,gif,webp', 'max:307200'],
